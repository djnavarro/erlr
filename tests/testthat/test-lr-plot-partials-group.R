test_that("build_group_boxplot returns geom + coord", {
  ...
  expect_no_error(p1 |> lr_plot_show_groups(treatment, style = "boxplot"))
  expect_no_error(p2 |> lr_plot_show_groups(treatment, style = "boxplot"))

  p1 <- p1 |> lr_plot_show_groups(treatment, style = "boxplot")
  p2 <- p2 |> lr_plot_show_groups(treatment, style = "boxplot")
...
test_that("build_group_violin returns geom + coord", {
  ...
  expect_no_error(p1 |> lr_plot_show_groups(treatment, style = "violin"))
  expect_no_error(p2 |> lr_plot_show_groups(treatment, style = "violin"))

  p1 <- p1 |> lr_plot_show_groups(treatment, style = "violin")
