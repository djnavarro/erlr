...
test_that("build_model_spaghetti returns 2 geoms", {
  ...
  expect_no_error(p1 |> lr_plot_show_model(style = "spaghetti"))
  expect_no_error(p2 |> lr_plot_show_model(style = "spaghetti"))

  p1 <- p1 |> lr_plot_show_model(style = "spaghetti")
  p2 <- p2 |> lr_plot_show_model(style = "spaghetti")
